                ...
                if($statement)
                {
                    ...
                    if($check)
                    {
                        ...
                        if(count($data)> 0)
                        {
                            ...
                            {
                                ?>
                                    <tr class="delete_mem<?php echo $rows['property_id'] ?>">
                                        ...
                                        <td><a href="../propertyDelete.php?property_id=<?php echo $rows['property_id']; ?>" class="btn"> <i class="fas fa-trash-alt"></i> Delete</td>
                                    </tr>
                                <?php
                            }
                        }
                        ...
                        {
                            ?>
                            <h1>There are no Listings available right now</h1>
                            <?php
                        }
                    }
                }
